...
<body>
	...
	<?php
		...
		{
			$user_id=$_COOKIE['user_id'];
			$query_add="SELECT 	adderss FROM users WHERE id='$user_id' LIMIT 1 ";
		...
		<div class="col-xs-3 side">
			<div class="sidebar_menu">
				<ul class="list-unstyled option">
					...
					<li class="active"><a href="setting_p_add_address.php">Update Your Address</a></li>
		...
		?>
			<div class="sidebar_content">
				...
				<div class="person_setting">
					<form action="setting_p_add_address_query.php" method="POST" id="address_update">
						<div class="update_address">
							
							<div class="input-group address">
							  <span class="input-group-addon"><i class="fa fa-home fa-fw"></i></span>
	  						  <input class="form-control" type="text" id="update_address" name="address_field" 
	  						  <?php if($result_add['adderss']==''){
	  						  	echo ' placeholder="Update your Current Address Now .." ';
	  						  }else{
	  						  	echo "value='".$result_add['adderss']."'";
	  						  }
	  						  ?> >
							</div>
							<!--error message -->
		                 	<div class="error text-center" id="error_p_update_address"><span>*Error testing</span></div>	

							<button class="btn-block update_address_btn" name="up_add">Update Address</button>
	    ...
	    <div class="modal-content mod_con">
	      ...
	      <div class="modal-body mod_body">
	        <h4 class="text-center h4"><img 
	        	<?php if(@$_SESSION['Success_Address_check']=="true"):?>
	        		src="../images/icon/accept.png"
	        	<?php else:?>
	        		src="../images/icon/cancel.png"
	        	<?php endif;?>
	        	/><b style="color:#080"><?php echo @$_SESSION['message_p_edit_Address_profile'];?></b> </h4>
	      </div>
	...
	<?php if(@$_SESSION['Success_Address_check']):?>
	...
	<?php endif;?>
	<?php @$_SESSION['Success_Address_check']=null;?>
