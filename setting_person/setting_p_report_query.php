...
if(isset($_POST['send_report']))
{
	...
	if($_COOKIE['Account_type']=='person')
	{
		...
		$query_report="INSERT INTO `contact_us`(`message`, `account_id`, `account_type`) VALUES ('$report','$user_id','p')";
		...
		if($perform_query_report)
		{
			...
			$_SESSION['message_p_send_report_profile']=$message;
			header("location: setting_p_report.php");
