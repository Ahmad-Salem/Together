		...
		<div class="col-xs-3 side">
			<div class="sidebar_menu">
				<ul class="list-unstyled option">
					...
					<li class="active"><a href="setting_p_add_photo.php">Update Your photo</a></li>
		...
		<div class="col-xs-9">
			...
			<div class="sidebar_content">
				...
				<div class="person_setting">
					...
					<form action="setting_p_add_photo_query.php" method="POST" id="photo_update_upload"  enctype="multipart/form-data">
						<!--error message -->
		                 <div class="error text-center" id="error_p_update_photo"><span>*Error testing</span></div>
						
						<div class="upload_photo_container">
							
								<div class="file-input wrapper photo_btn">
		            					               
		                                <input id="update_photo" type="file" name="image_person"  class="file-input control" />
		                   		 ...
		                   		 <button class="btn-block photo_in_btn" id="inpFileButton0">Upload Photo</button> 
	    ...
	    <div class="modal-content mod_con">
	      ...
	      <div class="modal-body mod_body">
	        <h4 class="text-center h4"><img 
	        	...
	        	><?php echo @$_SESSION['message_p_add_photo'];?></b> </h4>
	      </div>
