...
<body>
				...
				<div class="person_setting">
					<div class="change_password">
						<form method="POST">
							...
							<!--error message -->
	                        <div class="error" id="error_p_old_password"><span>*Error testing</span></div>	
	                    </form> 
	                    <div id="update_password_p_ax"></div>   
	    ...
	    <div class="modal-content mod_con">
	      ...
	      <div class="modal-body mod_body">
	        <h4 class="text-center h4"><img 
	        	<?php if(@$_SESSION['Success_pass_check']==true):?>
	        		src="../images/icon/accept.png"
	        	<?php else:?>
	        		src="../images/icon/cancel.png"
	        	<?php endif;?>
	        	/><b style="color:#080"><?php echo @$_SESSION['message_p_changepassword_profile'];?></b> </h4>
	      </div>
	...
	<?php if(@$_SESSION['Success_pass_check']):?>
	...
	<?php endif;?>
	<?php @$_SESSION['Success_pass_check']=null;?>
