<?php
	...
	{
		$post_id_target=$_POST['post_id'];
		$account_id_target=$_POST['account_id'];
		$account_type_target=$_POST['account_type'];

		if($_COOKIE['Account_type']=='person')
		{
			$query_number_of_posts="SELECT * FROM `normal_posts` WHERE `id`='{$post_id}' AND `account_id`='$account_id_target' AND `account_type`='$account_type_target' LIMIT 1";
