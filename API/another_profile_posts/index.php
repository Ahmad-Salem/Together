<?php
	...
	{
		if(isset($_POST['posting_type'])&&isset($_POST['another_account_id'])&&isset($_POST['another_account_type'])&&isset($_POST['account_id'])&&isset($_POST['account_type']))
		{
			if($_POST['posting_type']=='main_another_pro_acc')
			{	
				...
				$query_normal_posts="SELECT `id`, `account_id`, `account_type`,`caption`, `date` FROM `normal_posts` WHERE   `account_id`='$another_account_id' AND `account_type`='$another_account_type'  ORDER BY id DESC LIMIT 5";
