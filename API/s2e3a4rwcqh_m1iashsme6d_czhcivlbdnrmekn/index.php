<?php
	...
	if($_POST['do_Action']=='announcement_action_search')
	{
		if(isset($_POST['posting_type'])&&isset($_POST['account_id'])&&isset($_POST['account_type'])&&isset($_POST['search']))
		{
			if($_POST['posting_type']=='announcement_se')
			{
				$search=$_POST['search'];
				$query_announcement="SELECT `id`, `account_id`, `account_type`, `child_name`, `age`, `tall`, `skin_color`, `country`, `hair_color`, `lastSeen`, `description_lost_found`, `eye_color`, `description_contact`, `description_relation_with_child`, `description_child_status`, `request_type`, `date` FROM `request_post` WHERE `child_name` LIKE '%$search%' ";
	...
	if($_POST['do_Action']=='announcement_action_filter')
	{
		if(isset($_POST['posting_type'])&&isset($_POST['account_id'])&&isset($_POST['account_type']))
		{
			if($_POST['posting_type']=='announcement_fi')
			{
				...
				$query_announcement="SELECT `id`, `account_id`, `account_type`, `child_name`, `age`, `tall`, `skin_color`, `country`, `hair_color`, `lastSeen`, `description_lost_found`, `eye_color`, `description_contact`, `description_relation_with_child`, `description_child_status`, `request_type`, `date` FROM `request_post` WHERE `country`='$country' || `lastSeen`='$lastSeen' || `hair_color`='$hair_color' || `eye_color`='$eye_color' || `age`='$age' || `skin_color`='$skin_color' ";
				$perform_query_announcement=mysqli_query($connect,$query_announcement);
				$announcement_post_info['data']=array();
				while($result_announcement=mysqli_fetch_assoc($perform_query_announcement))
				{
