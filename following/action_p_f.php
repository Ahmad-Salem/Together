...
if($action=='trust')
{
	$query_trust="INSERT INTO `following`(`account_followed_id`, `account_followed_type`,`account_following_id`, `account_following_type`) VALUES ('$my_account_id','p','$account_id','f')";
...
if($action=='untrust')
{
	$query_untrust="DELETE FROM `following` WHERE `account_followed_id`='$my_account_id' AND `account_followed_type`='p' AND `account_following_id`='$account_id' AND `account_following_type`='f' LIMIT 1 ";
