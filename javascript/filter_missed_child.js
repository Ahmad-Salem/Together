$(document).ready(function(){
	...
	function filter_search_result()
	{
        ...
        var url = "../all_request_posts/filter_result.php";
	    ...
	    if(hr.readyState == 4 && hr.status == 200) {
		    ...
		    if(jArraygetfilteredResults!=null)
			{
				...
				$.each( jArraygetfilteredResults, function( key, value ){
					...
					{
						//filtered result
						$("#filter_result_container").append("<div class=\"result_item\"><a href=\"../all_request_posts/display_request_post_missed_childs.php?requets_num="+value.request_id+"\"><img  src=\"../request_post_attachment/user/"+value.account_id+"/"+value.request_id+"/"+value.image+"\" title=\""+value.child_name+"\"/></a><h5 class=\"text-center\"><a href=\"display_request_post.php?requets_num="+value.request_id+"\">"+value.child_name+"</a></h5></div>");
						
					}else if(value.account_type=='f')
					{
						//filtered result
						//filtered result
						$("#filter_result_container").append("<div class=\"result_item\"><a href=\"../all_request_posts/display_request_post_missed_childs.php?requets_num="+value.request_id+"\"><img  src=\"../request_post_attachment/foundation/"+value.account_id+"/"+value.request_id+"/"+value.image+"\" title=\""+value.child_name+"\"/></a><h5 class=\"text-center\"><a href=\"display_request_post.php?requets_num="+value.request_id+"\">"+value.child_name+"</a></h5></div>");
	...
	function filter_search_name_result()
	{
        ...
        var url = "../all_request_posts/search_filter.php";
