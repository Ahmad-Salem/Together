...
<body>
    <?php
        ...
        $query="SELECT name, email,country ,city ,description ,telephone_number1 FROM `foundations` WHERE id = '$foundation_id' LIMIT 1";
        $perform_query_foundation=mysqli_query($connect,$query);
        $result_query=mysqli_fetch_assoc($perform_query_foundation);
    ?>
    <?php
	...
	<div class="container setting" id="foundation_setting">
		<div class="col-xs-3 side">
			<div class="sidebar_menu">
				<ul class="list-unstyled option">
					<li class="active"><a href="setting_f.php">Edit  Profile</a></li>
					<li><a href="setting_f_change_password.php">Change Password</a></li>
					<li><a href="setting_f_update_photo.php">Update  photo</a></li>
		...
		<div class="col-xs-9">
			...
			<div class="sidebar_content">
				...
				<div class="sidebar_content_header">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
					<h4 class="text-center" style="display:inline;"><?php echo @$_SESSION['Message_Update'];?> <b><?php echo $result['name'];?></b> </h4>
				</div>
			
				<div class="foundation_setting">

					<form method="POST" action="setting_f_query.php" id="foundation_submit" enctype="multipart/form-data"> 
                           <!-- Foundation Name -->
                           <div class="input-group margin-bottom-sm Name">
                                <span class="input-group-addon">
                                    <i class="fa fa-pencil fa-fw"></i></span>
                                <input class="form-control" type="text" id="foundation_name" value="<?php echo $result_query['name'];?>" name="foundation_name">
                           </div>
                           <!--error message -->
                           ...
                           <div class="input-group margin-bottom-sm Email">
                                ...
                                <input class="form-control" type="text" id="foundation_email"  value="<?php echo $result_query['email'];?>" name="foundation_email">
                           </div>
                           <!--error message -->
                          ...
                          <div class="kind">
                              <select  id="foundation_country" name="foundation_country">
                                    ...
                                    <option 
                                    <?php if($result_query['country']=="Egypt"):?>
                                        selected
                                    <?php endif;?>
                                    value="Egypt"
                                    >Egypt</option>
                           ...
                           <!-- Foundation city-->
                           <div class="input-group margin-bottom-sm city">
                                <span class="input-group-addon">
                                    <i class="fa fa-home fa-fw"></i></span>
                                <input class="form-control" type="text" id="foundation_city" value="<?php echo $result_query['city'];?>" name="foundation_city">
                           </div>
                           <!--error message -->
                           ...
                           <div class="input-group Description">
                               <textarea  name="foundation_description" id="foundation_description"><?php echo $result_query['description'];?></textarea>
                           </div>
                           <!--error message -->
                           ...
                           <input type="submit" value="Update" name="foundation_submit" class="Submit-btn" />
                    </form>
        ...
        <div class="modal-content mod_con">
          ...
          <div class="modal-body mod_body">
            <h4 class="text-center h4"><img 
                <?php if(@$_SESSION['Success_check_f']=="true"):?>
                    src="../images/icon/accept.png"
                <?php else:?>
                    src="../images/icon/cancel.png"
                <?php endif;?>
                /><b style="color:#080"><?php echo @$_SESSION['message_f_edit_profile'];?></b> </h4>
          </div>
    ...
    <?php if(@$_SESSION['Success_check_f']):?>
    ...
    <?php endif;?>
    <?php @$_SESSION['Success_check_f']=null;?>
