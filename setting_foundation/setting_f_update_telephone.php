...
<body>
	...
	<?php
		...
		{
			$foundation_id=$_COOKIE['foundation_id'];
			$query_tel="SELECT `telephone_number1` FROM `foundations` WHERE  id='$foundation_id' LIMIT 1 ";
		...
		<div class="col-xs-3 side">
			<div class="sidebar_menu">
				<ul class="list-unstyled option">
					...
					<li class="active"><a href="setting_f_update_telephone.php">Update  Telephone</a></li>
		...
		<div class="col-xs-9">
			...
			<div class="sidebar_content">
				...
				<div class="foundation_setting">
					...
					<form action="setting_f_update_telephone_query.php" method="POST" id="foundation_tele_sub"> 
						<div class="update_telephone_p">
							<div class="input-group telephnoe_p">
							  <span class="input-group-addon"><i class="fa fa-home fa-fw"></i></span>
	  						  <input class="form-control" type="text" id="foundation_tele" name="foundation_telephone_Num"
							...
							<!--error message -->
	                        <div class="error" id="error_f_tele"><span>*Error testing</span></div>
							<button class="btn-block telephone_btn_p" name="U_TEL"> Update Telephone </button>
						</div>
					</form>
        ...
        <div class="modal-content mod_con">
          ...
          <div class="modal-body mod_body">
            <h4 class="text-center h4"><img 
                <?php if(@$_SESSION['Success_Tel_check_f']=="true"):?>
                    src="../images/icon/accept.png"
                <?php else:?>
                    src="../images/icon/cancel.png"
                <?php endif;?>
                /><b style="color:#080"><?php echo @$_SESSION['message_f_edit_Tel_profile'];?></b> </h4>
          </div>
    ...
    <?php if(@$_SESSION['Success_Tel_check_f']):?>
    ...
    <?php endif;?>
    <?php @$_SESSION['Success_Tel_check_f']=null;?>
