...
<body>
    ...
    <?php
		...
		{
			$foundation_id=$_COOKIE['foundation_id'];
			$query_site="SELECT `site_link` FROM `foundations` WHERE  id='$foundation_id' LIMIT 1 ";
			$perform_query_site=mysqli_query($connect,$query_site);
			$result_add=mysqli_fetch_assoc($perform_query_site);
		}else{
			$message="<div class=\"Error_login\"><span class=\"mainerror\"> A Conflict Occurs </span></div>";
 			$_SESSION['Message_login']=$message;
 			header("location: ../logout.php");
		...
		<div class="col-xs-3 side">
			<div class="sidebar_menu">
				<ul class="list-unstyled option">
					...
					<li class="active"><a href="setting_f_update_site_link.php">Update  Site</a></li>
		...
		<div class="col-xs-9">
			...
			<div class="sidebar_content">
				...
				<div class="foundation_setting">
					<form action="setting_f_update_site_link_query.php" method="POST" id="foundation_sitel_sub">
						<div class="link_container">
							<div class="input-group link">
							  <span class="input-group-addon"><i class="fa fa-home fa-fw"></i></span>
	  						  
							  <input class="form-control" type="text" id="foundation_sitel" name="foundation_Site"
	  						  
	  						  <?php if($result_add['site_link']==''){
	  						  	echo ' placeholder=" Update Site Link ..." ';
	  						  }else{
	  						  	echo "value='".$result_add['site_link']."'";
	  						  }
	  						  ?>
	  						   />	
							</div>
							<!--error message -->
                            <div class="error" id="error_f_site"><span>*Error testing</span></div>

							<button class="btn-block link_btn" name="site_f"> Update Site Link </button>
						</div>
					</form>
        ...
        <div class="modal-content mod_con">
          ...
          <div class="modal-body mod_body">
            <h4 class="text-center h4"><img 
                <?php if(@$_SESSION['Success_Site_check_f']=="true"):?>
                    src="../images/icon/accept.png"
                <?php else:?>
                    src="../images/icon/cancel.png"
                <?php endif;?>
                /><b style="color:#080"><?php echo @$_SESSION['message_f_edit_site_profile'];?></b> </h4>
          </div>
    ...
    <?php if(@$_SESSION['Success_Site_check_f']):?>
    ...
    <?php endif;?>
    <?php @$_SESSION['Success_Site_check_f']=null;?>
