...
<body>
    ...
    <?php
		...
		{
			$foundation_id=$_COOKIE['foundation_id'];
			$query_add="SELECT 	address FROM foundations WHERE id='$foundation_id' LIMIT 1 ";
			$perform_query_add=mysqli_query($connect,$query_add);
			$result_add=mysqli_fetch_assoc($perform_query_add);
		}else{
			$message="<div class=\"Error_login\"><span class=\"mainerror\"> A Conflict Occurs </span></div>";
 			@$_SESSION['Message_login']=$message;
 			header("location: ../logout.php");
		...
		<div class="col-xs-3 side">
			<div class="sidebar_menu">
				<ul class="list-unstyled option">
					...
					<li class="active"><a href="setting_f_update_address.php">Update  Address</a></li>
		...
		<div class="col-xs-9">
			...
			<div class="sidebar_content">
				...
				<div class="foundation_setting">
					<form action="setting_f_update_address_query.php" method="POST" id="foundation_add_sub">
						<div class="update_address_p">
							<div class="input-group address_p">
							  <span class="input-group-addon"><i class="fa fa-home fa-fw"></i></span>
	  						  <input class="form-control" type="text" id="update_address" name="address_field" 
	  						  <?php if($result_add['address']==''){
	  						  	echo ' placeholder="Update your Current Address Now .." ';
	  						  }else{
	  						  	echo "value='".$result_add['address']."'";
	  						  }
	  						  ?> />
							</div>
							<!--error message -->
	                        <div class="error" id="error_f_add"><span>*Error testing</span></div>

							<button class="btn-block update_address_btn_p" name="update_foundation_btn">Update Address</button>
        ...
        <div class="modal-content mod_con">
          ...
          <div class="modal-body mod_body">
            <h4 class="text-center h4"><img 
                <?php if(@$_SESSION['Success_Address_check_f']=="true"):?>
                    src="../images/icon/accept.png"
                <?php else:?>
                    src="../images/icon/cancel.png"
                <?php endif;?>
                /><b style="color:#080"><?php echo @$_SESSION['message_f_edit_Address_profile'];?></b> </h4>
          </div>
    ...
    <?php if(@$_SESSION['Success_Address_check_f']):?>
    ...
    <?php endif;?>
    <?php @$_SESSION['Success_Address_check_f']=null;?>
