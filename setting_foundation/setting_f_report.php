		...
		<div class="col-xs-3 side">
			<div class="sidebar_menu">
				<ul class="list-unstyled option">
					...
					<li class="active"><a href="setting_f_report.php">Contact Us</a></li>
			...
			<div class="sidebar_content">
				...
				<div class="person_setting">
					...
					<div class="contact_us">
							<form action="setting_f_report_query.php" method="POST" id="contact_us_setting">
	    ...
	    <div class="modal-content mod_con">
	      ...
	      <div class="modal-body mod_body">
	        <h4 class="text-center h4"><img 
	        	...
	        	<?php endif;?>
	        	/><b style="color:#080"><?php echo @$_SESSION['message_f_send_report_profile'];?></b> </h4>
	      </div>
