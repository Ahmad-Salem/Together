...
<body>
    ...
    <?php
		...
		{
			$foundation_id=$_COOKIE['foundation_id'];
			$query_tel="SELECT `fax` FROM `foundations` WHERE  id='$foundation_id' LIMIT 1 ";
		...
		<div class="col-xs-3 side">
			<div class="sidebar_menu">
				<ul class="list-unstyled option">
					...
					<li class="active"><a href="setting_f_update_fax.php">Update  Fax</a></li>
		...
		<div class="col-xs-9">
			...
			<div class="sidebar_content">
				...
				<div class="foundation_setting">
					<form action="setting_f_update_fax_query.php" method="POST" id="foundation_fax_sub">
						<div class="fax_container">
							<div class="input-group fax">
							  <span class="input-group-addon"><i class="fa fa-home fa-fw"></i></span>
	  						  
	  						  <input class="form-control" type="text" id="foundation_faxx" name="foundation_FAX"
	  						  <?php if($result_add['fax']==''){
	  						  	echo ' placeholder=" Update Fax Number ..." ';
	  						  }else{
	  						  	echo "value='".$result_add['fax']."'";
	  						  }
	  						  ?>
	  						   />	
							</div>
							<!--error message -->
	                        <div class="error" id="error_f_faxx"><span>*Error testing</span></div>
							
							<button class="btn-block fax_btn" name="F_FAX"> Update Fax </button>
						</div>
					</form>
				</div>
        ...
        <div class="modal-content mod_con">
          ...
          <div class="modal-body mod_body">
            <h4 class="text-center h4"><img 
                <?php if(@$_SESSION['Success_Fax_check_f']=="true"):?>
                    src="../images/icon/accept.png"
                <?php else:?>
                    src="../images/icon/cancel.png"
                <?php endif;?>
                /><b style="color:#080"><?php echo @$_SESSION['message_f_edit_fax_profile'];?></b> </h4>
          </div>
    ...
    <?php if(@$_SESSION['Success_Fax_check_f']):?>
    ...
    <?php endif;?>
    <?php @$_SESSION['Success_Fax_check_f']=null;?>
