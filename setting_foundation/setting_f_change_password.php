...
<body>
		...
		<div class="col-xs-3 side">
			<div class="sidebar_menu">
				<ul class="list-unstyled option">
					...
					<li class="active"><a href="setting_f_change_password.php">Change Password</a></li>
		...
		<div class="col-xs-9">
			...
			<div class="sidebar_content">
				...
				<div class="foundation_setting">
					<div class="change_password_f">
						<form method="POST">
								<!-- old password field -->
								<div class="input-group new_password f_old">
								  <span class="input-group-addon"><i class="fa fa-key fa-fw"></i></span>
		  						  <input class="form-control" type="password" placeholder="Enter Your Current Password" 
		  						  id="old_password_f" name="old_password_f">
								</div>
								<!--error message -->
		                        <div class="error" id="error_f_old_password"><span>*Error testing</span></div>	
		                </form>
						
						<div id="update_password_f_ax"></div>
					</div>
				</div>
	    ...
	    <div class="modal-content mod_con">
	      ...
	      <div class="modal-body mod_body">
	        <h4 class="text-center h4"><img 
	        	<?php if(@$_SESSION['Success_pass_check_f']=="true"):?>
	        		src="../images/icon/accept.png"
	        	<?php else:?>
	        		src="../images/icon/cancel.png"
	        	<?php endif;?>
	        	/><b style="color:#080"><?php echo @$_SESSION['message_f_changepassword_profile'];?></b> </h4>
	      </div>
    ...
    <?php if(@$_SESSION['Success_pass_check_f']):?>
	...
	<?php endif;?>
	<?php @$_SESSION['Success_pass_check_f']=null;?>
